...
SEC_FLOATING_FEATURE_LOCKSCREEN_CONFIG_PUNCHHOLE_VI=face,pos:0.5:0.025,size:0.0905:0.0542,type:circle
...
# RAM Plus
SEC_FLOATING_FEATURE_SMARTMANAGER_CONFIG_RAM_PLUS=TRUE
